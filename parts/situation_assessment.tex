...
% Kirill did tube only version. Probably, we need to say that we do not have data with pictures of sharker, box and so on, but it is not a problem, to create it.
%
%\begin{itemize}
